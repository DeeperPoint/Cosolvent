const HELP_ENTRIES = [
  ...
  },
  {
    ...
    description: "Allows unauthenticated visitors to use discovery search endpoints.",
    whyItMatters: "Greatly changes your exposure surface for public users.",
    example: "Off by default, on for public directory-style marketplaces.",
    recommendedDefault: "Disabled unless you intentionally support public search.",
    riskLevel: "high",
  },
  {
    pattern: "discovery.access.anonymous_filter_mode",
    label: "Anonymous Filter Mode",
    description: "Controls whether anonymous users can apply discovery filters.",
    whyItMatters: "Filter policy affects inference risk for protected/private attributes.",
    example: "public_only allows safe filtering on public fields.",
  ...
  },
  {
    ...
    description: "Selects how profile search ranking is computed.",
    whyItMatters: "Determines whether discovery is hybrid or strict vector-first.",
    example: "rag_strict for semantic-first ranking.",
    recommendedDefault: "hybrid while testing, rag_strict for production semantic retrieval.",
    riskLevel: "medium",
  },
  {
    pattern: "discovery.ai.rag_failure_behavior",
    label: "RAG Failure Behavior",
    description: "Defines what happens if strict vector retrieval is unavailable.",
    whyItMatters: "Controls whether outages fail loudly or return no matches.",
    example: "service_unavailable returns HTTP 503.",
