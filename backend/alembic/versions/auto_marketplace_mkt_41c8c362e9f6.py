...
revision = "mkt_41c8c362e9f6"
down_revision = "mkt_847a3486fa54"
branch_labels = None
depends_on = None
...
SPEC_HASH = "41c8c362e9f639bf6172aed3bba5421a25227084091bf4847dfd46472d67febc"
BUILD_MODE = "mvp"
...
def downgrade() -> None:
    op.execute("DELETE FROM marketplace_builds WHERE spec_hash = '41c8c362e9f639bf6172aed3bba5421a25227084091bf4847dfd46472d67febc'")
