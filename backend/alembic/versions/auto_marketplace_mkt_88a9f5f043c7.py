...
PROFILE_FIELD_DEFS = [{'slug': 'seller', 'section_name': 'Company', 'field_name': 'company_name', 'field_label': 'Company Name', 'field_type': 'text', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 1}, {'slug': 'seller', 'section_name': 'Company', 'field_name': 'country', 'field_label': 'Country', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['USA', 'Canada', 'Mexico', 'Germany', 'Italy', 'Japan', 'China', 'South Korea', 'India', 'Brazil'], 'accepted_types_json': None, 'ordinal': 2}, {'slug': 'seller', 'section_name': 'Company', 'field_name': 'description', 'field_label': 'About', 'field_type': 'rich_text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 3}, {'slug': 'seller', 'section_name': 'Offering', 'field_name': 'machinery_category', 'field_label': 'Machinery Category', 'field_type': 'multi_select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['Construction', 'Agriculture', 'Manufacturing / CNC', 'Material Handling', 'Mining', 'Power Generation', 'Forestry', 'Oil & Gas'], 'accepted_types_json': None, 'ordinal': 4}, {'slug': 'seller', 'section_name': 'Offering', 'field_name': 'brand', 'field_label': 'Brand', 'field_type': 'multi_select', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': ['Caterpillar', 'Komatsu', 'John Deere', 'Volvo', 'Hitachi', 'JCB', 'Liebherr', 'Doosan', 'Mitsubishi', 'Other'], 'accepted_types_json': None, 'ordinal': 5}, {'slug': 'seller', 'section_name': 'Offering', 'field_name': 'condition', 'field_label': 'Condition', 'field_type': 'multi_select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['New', 'Used', 'Refurbished', 'Parts Only'], 'accepted_types_json': None, 'ordinal': 6}, {'slug': 'seller', 'section_name': 'Offering', 'field_name': 'certifications', 'field_label': 'Certifications', 'field_type': 'multi_select', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': ['ISO 9001', 'CE Marking', 'OSHA Compliant', 'EPA Tier 4'], 'accepted_types_json': None, 'ordinal': 7}, {'slug': 'seller', 'section_name': 'Offering', 'field_name': 'average_unit_price_usd', 'field_label': 'Average Unit Price Usd', 'field_type': 'number', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 8}, {'slug': 'seller', 'section_name': 'Offering', 'field_name': 'spec_sheets', 'field_label': 'Spec Sheets / Documents', 'field_type': 'files', 'visibility': 'private', 'required': False, 'searchable': False, 'options_json': None, 'accepted_types_json': ['pdf'], 'ordinal': 9}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'company_name', 'field_label': 'Organization Name', 'field_type': 'text', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 1}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'country', 'field_label': 'Country', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['USA', 'Canada', 'Mexico', 'Germany', 'Italy', 'Japan', 'China', 'South Korea', 'India', 'Brazil'], 'accepted_types_json': None, 'ordinal': 2}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'description', 'field_label': 'About', 'field_type': 'rich_text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 3}, {'slug': 'buyer', 'section_name': 'Requirements', 'field_name': 'machinery_category', 'field_label': 'Machinery Category', 'field_type': 'multi_select', 'visibility': 'protected', 'required': True, 'searchable': True, 'options_json': ['Construction', 'Agriculture', 'Manufacturing / CNC', 'Material Handling', 'Mining', 'Power Generation', 'Forestry', 'Oil & Gas'], 'accepted_types_json': None, 'ordinal': 4}, {'slug': 'buyer', 'section_name': 'Requirements', 'field_name': 'brand', 'field_label': 'Brand', 'field_type': 'multi_select', 'visibility': 'protected', 'required': False, 'searchable': True, 'options_json': ['Caterpillar', 'Komatsu', 'John Deere', 'Volvo', 'Hitachi', 'JCB', 'Liebherr', 'Doosan', 'Mitsubishi', 'Other'], 'accepted_types_json': None, 'ordinal': 5}, {'slug': 'buyer', 'section_name': 'Requirements', 'field_name': 'condition', 'field_label': 'Condition', 'field_type': 'multi_select', 'visibility': 'protected', 'required': True, 'searchable': True, 'options_json': ['New', 'Used', 'Refurbished', 'Parts Only'], 'accepted_types_json': None, 'ordinal': 6}, {'slug': 'buyer', 'section_name': 'Requirements', 'field_name': 'certifications', 'field_label': 'Certifications', 'field_type': 'multi_select', 'visibility': 'protected', 'required': False, 'searchable': True, 'options_json': ['ISO 9001', 'CE Marking', 'OSHA Compliant', 'EPA Tier 4'], 'accepted_types_json': None, 'ordinal': 7}, {'slug': 'buyer', 'section_name': 'Requirements', 'field_name': 'average_unit_price_usd', 'field_label': 'Average Unit Price Usd', 'field_type': 'number', 'visibility': 'protected', 'required': False, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 8}, {'slug': 'buyer', 'section_name': 'Requirements', 'field_name': 'budget_range', 'field_label': 'Typical Budget per Order', 'field_type': 'select', 'visibility': 'protected', 'required': False, 'searchable': False, 'options_json': ['Under 25k', '25k-100k', '100k-500k', '500k-2M', '2M+'], 'accepted_types_json': None, 'ordinal': 9}, {'slug': 'service_provider', 'section_name': 'Company', 'field_name': 'company_name', 'field_label': 'Company Name', 'field_type': 'text', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 1}, {'slug': 'service_provider', 'section_name': 'Company', 'field_name': 'country', 'field_label': 'Country', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['USA', 'Canada', 'Mexico', 'Germany', 'Italy', 'Japan', 'China', 'South Korea', 'India', 'Brazil'], 'accepted_types_json': None, 'ordinal': 2}, {'slug': 'service_provider', 'section_name': 'Company', 'field_name': 'description', 'field_label': 'About', 'field_type': 'rich_text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 3}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'services_offered', 'field_label': 'Services Offered', 'field_type': 'multi_select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['Transport Carrier', 'Rigging Specialist', 'Machinery Inspector', 'Customs Broker', 'Cargo Insurer'], 'accepted_types_json': None, 'ordinal': 4}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'service_regions', 'field_label': 'Service Regions', 'field_type': 'multi_select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['North America', 'South America', 'Europe', 'Middle East', 'Africa', 'South Asia', 'East Asia', 'Southeast Asia', 'Oceania'], 'accepted_types_json': None, 'ordinal': 5}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'equipment_types', 'field_label': 'Equipment Types', 'field_type': 'multi_select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['Flatbed', 'Step Deck', 'Double Drop / Lowboy', 'Removable Gooseneck (RGN)', 'Container', 'Roll-On/Roll-Off', 'Heavy Haul Specialized'], 'accepted_types_json': None, 'ordinal': 6}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'carrier_certifications', 'field_label': 'Carrier Certifications', 'field_type': 'multi_select', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': ['DOT Compliant', 'ADR (EU)', 'TIR Carnet', 'ISO 9001', 'C-TPAT'], 'accepted_types_json': None, 'ordinal': 7}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'credentials', 'field_label': 'Credentials / Certificates', 'field_type': 'files', 'visibility': 'private', 'required': False, 'searchable': False, 'options_json': None, 'accepted_types_json': ['pdf'], 'ordinal': 8}]
SPEC_HASH = "88a9f5f043c7de30f133214423d2c00a640b6ee6c3685cc677a050724510d82d"
BUILD_MODE = "mvp"
...
def downgrade() -> None:
    op.execute("DELETE FROM marketplace_builds WHERE spec_hash = '88a9f5f043c7de30f133214423d2c00a640b6ee6c3685cc677a050724510d82d'")
