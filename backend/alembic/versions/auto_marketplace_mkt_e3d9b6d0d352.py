...
PROFILE_FIELD_DEFS = [{'slug': 'seller', 'section_name': 'Company', 'field_name': 'company_name', 'field_label': 'Company Name', 'field_type': 'text', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 1}, {'slug': 'seller', 'section_name': 'Company', 'field_name': 'country', 'field_label': 'Country', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['USA', 'Canada', 'Mexico', 'Germany', 'Brazil', 'India', 'China', 'Japan'], 'accepted_types_json': None, 'ordinal': 2}, {'slug': 'seller', 'section_name': 'Company', 'field_name': 'description', 'field_label': 'About', 'field_type': 'rich_text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 3}, {'slug': 'seller', 'section_name': 'Offering', 'field_name': 'spec_sheets', 'field_label': 'Spec Sheets / Documents', 'field_type': 'files', 'visibility': 'private', 'required': False, 'searchable': False, 'options_json': None, 'accepted_types_json': ['pdf'], 'ordinal': 4}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'company_name', 'field_label': 'Organization Name', 'field_type': 'text', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 1}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'country', 'field_label': 'Country', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['USA', 'Canada', 'Mexico', 'Germany', 'Brazil', 'India', 'China', 'Japan'], 'accepted_types_json': None, 'ordinal': 2}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'description', 'field_label': 'About', 'field_type': 'rich_text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 3}, {'slug': 'buyer', 'section_name': 'Requirements', 'field_name': 'budget_range', 'field_label': 'Typical Budget per Order', 'field_type': 'select', 'visibility': 'protected', 'required': False, 'searchable': False, 'options_json': ['Under 25k', '25k-100k', '100k-500k', '500k-2M', '2M+'], 'accepted_types_json': None, 'ordinal': 4}, {'slug': 'service_provider', 'section_name': 'Company', 'field_name': 'company_name', 'field_label': 'Company Name', 'field_type': 'text', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 1}, {'slug': 'service_provider', 'section_name': 'Company', 'field_name': 'country', 'field_label': 'Country', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['USA', 'Canada', 'Mexico', 'Germany', 'Brazil', 'India', 'China', 'Japan'], 'accepted_types_json': None, 'ordinal': 2}, {'slug': 'service_provider', 'section_name': 'Company', 'field_name': 'description', 'field_label': 'About', 'field_type': 'rich_text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'accepted_types_json': None, 'ordinal': 3}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'services_offered', 'field_label': 'Services Offered', 'field_type': 'multi_select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['Broker', 'Inspection Service', 'Financing Provider', 'Logistics Provider', 'Dispute Manager'], 'accepted_types_json': None, 'ordinal': 4}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'service_regions', 'field_label': 'Service Regions', 'field_type': 'multi_select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['North America', 'South America', 'Europe', 'Middle East', 'Africa', 'South Asia', 'East Asia', 'Southeast Asia', 'Oceania'], 'accepted_types_json': None, 'ordinal': 5}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'region', 'field_label': 'Primary Region', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['north_america', 'south_america', 'europe', 'middle_east', 'africa', 'asia', 'oceania'], 'accepted_types_json': None, 'ordinal': 6}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'customs_handling', 'field_label': 'Customs Handling', 'field_type': 'select', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': ['buyer_handles', 'seller_handles', 'platform_assisted', 'broker_managed'], 'accepted_types_json': None, 'ordinal': 7}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'delivery_status', 'field_label': 'Delivery Status', 'field_type': 'select', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': ['not_started', 'in_logistics', 'in_transit', 'delivered', 'completed'], 'accepted_types_json': None, 'ordinal': 8}, {'slug': 'service_provider', 'section_name': 'Services', 'field_name': 'credentials', 'field_label': 'Credentials / Certificates', 'field_type': 'files', 'visibility': 'public', 'required': False, 'searchable': False, 'options_json': None, 'accepted_types_json': ['pdf'], 'ordinal': 9}]
SPEC_HASH = "e3d9b6d0d352436945654d1857b94ec9677ce04ea74d0a6ceb40c077b5eadc3f"
BUILD_MODE = "mvp"
...
def downgrade() -> None:
    op.execute("DELETE FROM marketplace_builds WHERE spec_hash = 'e3d9b6d0d352436945654d1857b94ec9677ce04ea74d0a6ceb40c077b5eadc3f'")
