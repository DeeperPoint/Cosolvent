...
revision = "mkt_9a6330f63fe9"
down_revision = "mkt_fdc097f304d2"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.execute("DELETE FROM marketplace_builds WHERE spec_hash = '9a6330f63fe945c87f035ee6aa59fbf6acfa5a7a81426fac7321a3d0aa21b2b2'")
