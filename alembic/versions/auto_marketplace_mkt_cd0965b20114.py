...
PROFILE_FIELD_DEFS = [{'slug': 'producer', 'section_name': 'Basic Information', 'field_name': 'farm_name', 'field_label': 'Farm Name', 'field_type': 'text', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': None, 'ordinal': 1}, {'slug': 'producer', 'section_name': 'Basic Information', 'field_name': 'country', 'field_label': 'Country', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['Canada', 'USA', 'Brazil', 'Australia', 'Argentina'], 'ordinal': 2}, {'slug': 'producer', 'section_name': 'Basic Information', 'field_name': 'region', 'field_label': 'Region/Province', 'field_type': 'text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'ordinal': 3}, {'slug': 'producer', 'section_name': 'Basic Information', 'field_name': 'primary_crops', 'field_label': 'Primary Crops', 'field_type': 'multi_select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['Wheat', 'Barley', 'Canola', 'Oats', 'Lentils', 'Peas', 'Flax'], 'ordinal': 4}, {'slug': 'producer', 'section_name': 'Basic Information', 'field_name': 'description', 'field_label': 'Description', 'field_type': 'rich_text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'ordinal': 5}, {'slug': 'producer', 'section_name': 'Production Details', 'field_name': 'annual_production', 'field_label': 'Annual Production (MT)', 'field_type': 'number', 'visibility': 'protected', 'required': False, 'searchable': True, 'options_json': None, 'ordinal': 6}, {'slug': 'producer', 'section_name': 'Production Details', 'field_name': 'certifications', 'field_label': 'Certifications', 'field_type': 'multi_select', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': ['Organic', 'Non-GMO', 'Fair Trade', 'ISO 22000'], 'ordinal': 7}, {'slug': 'producer', 'section_name': 'Production Details', 'field_name': 'protein_content', 'field_label': 'Protein Content Range (%)', 'field_type': 'text', 'visibility': 'protected', 'required': False, 'searchable': True, 'options_json': None, 'ordinal': 8}, {'slug': 'producer', 'section_name': 'Production Details', 'field_name': 'storage_capacity', 'field_label': 'Storage Capacity (MT)', 'field_type': 'number', 'visibility': 'protected', 'required': False, 'searchable': False, 'options_json': None, 'ordinal': 9}, {'slug': 'producer', 'section_name': 'Internal', 'field_name': 'financial_notes', 'field_label': 'Financial Notes', 'field_type': 'text', 'visibility': 'private', 'required': False, 'searchable': False, 'options_json': None, 'ordinal': 10}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'org_name', 'field_label': 'Organization Name', 'field_type': 'text', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': None, 'ordinal': 1}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'country', 'field_label': 'Country', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['Canada', 'USA', 'Brazil', 'Japan', 'South Korea', 'Germany', 'Italy'], 'ordinal': 2}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'business_type', 'field_label': 'Business Type', 'field_type': 'select', 'visibility': 'public', 'required': True, 'searchable': True, 'options_json': ['Mill', 'Brewery', 'Bakery', 'Trading Company', 'Food Manufacturer', 'Other'], 'ordinal': 3}, {'slug': 'buyer', 'section_name': 'Organization', 'field_name': 'description', 'field_label': 'Description', 'field_type': 'rich_text', 'visibility': 'public', 'required': False, 'searchable': True, 'options_json': None, 'ordinal': 4}, {'slug': 'buyer', 'section_name': 'Sourcing Needs', 'field_name': 'crops_of_interest', 'field_label': 'Crops of Interest', 'field_type': 'multi_select', 'visibility': 'protected', 'required': False, 'searchable': False, 'options_json': ['Wheat', 'Barley', 'Canola', 'Oats', 'Lentils', 'Peas', 'Flax'], 'ordinal': 5}, {'slug': 'buyer', 'section_name': 'Sourcing Needs', 'field_name': 'annual_volume_needed', 'field_label': 'Annual Volume Needed (MT)', 'field_type': 'number', 'visibility': 'protected', 'required': False, 'searchable': False, 'options_json': None, 'ordinal': 6}]
...
def downgrade() -> None:
    op.execute("DELETE FROM marketplace_builds WHERE spec_hash = 'cd0965b201144ad27f7976332380d34a776d5ebbfc68543b9c44f550628ba753'")
