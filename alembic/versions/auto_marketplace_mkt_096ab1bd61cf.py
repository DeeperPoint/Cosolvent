...
def downgrade() -> None:
    op.execute("DELETE FROM marketplace_builds WHERE spec_hash = '096ab1bd61cf63b4c1b6209f8d9845f43e0235b00edffc18669afbe7ce089525'")
